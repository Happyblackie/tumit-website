...
export default function Signin() {
  ...
  return (
    <section className="px-4 py-10 min-h-screen flex items-center justify-center">
      ...
      <div className="w-full max-w-md mx-auto flex flex-col gap-8 -mt-20 md:-mt-40 xlg:-mt-60">
            ...
            <form action={action} className="flex flex-col gap-4">
                <div className="flex flex-col gap-5">
                    ...
                    <div className="flex justify-center mt-2">
                        ...
                        cursor-pointer hover:bg-gray-300 hover:text-black transition duration-200 border w-fit"
                        >                  
                    ...
                    <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mt-6">
                        ...
                        >
                            <Link href={'/signup'}><span className="text-sm">Don't have an account? <span className="font-bold">Sign up</span></span></Link>
                        ...
                        <button 
                            ...
                            className="flex items-center justify-center h-11 px-6 bg-white text-gray-800 rounded-full border border-gray-300 w-full sm:w-auto 
                                    cursor-pointer hover:bg-gray-50 hover:border-gray-400 transition-all duration-200 active:scale-95"
                        >
                            <Link href={'/'}><span className="text-sm">Forgot password?</span></Link>                    
                        </button>
                    </div>
                </div>
            </form>
